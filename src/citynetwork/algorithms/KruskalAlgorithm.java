...
// Kruskal's algorithm - builds MST by sorting edges and using Union-Find
public class KruskalAlgorithm {
    ...
    // Runs Kruskal's algorithm by processing sorted edges
    public static MSTResult execute(TransportNetwork network) {
        ...
        for (Road road : sorted) {
            // Try to merge - if successful, edge doesn't create cycle
